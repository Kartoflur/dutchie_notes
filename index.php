...
<header class="pageheader">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="navbar-nav ml-auto">
      <h5 class="mr-2 text-white"><?php echo '<i class="fa fa-user" style="color:yellowgreen"></i> Welcome! ', $_SESSION['firstname'] ?> <?php echo  $_SESSION['lastname'] ,'.' ?> </h5>
    </div>
    <div class="button-right">
    <button onclick="window.location = 'php/Logout.php?logout'" class="btn btn-outline-danger btn-lg" id="btn_signout" type="button"><i class="fa fa-sign-out"></i>Sign Out</button>
    </div>
